...
public class ProxyInfo2 {
    ...
    private void generateMethod(StringBuilder builder) {
        ...
        for (int id : mInjectMethods.keySet()) {
            ...
            builder.append("        object.findViewById(" + id + ").setOnClickListener(new View.OnClickListener(){\n");    // 方法二
            builder.append("            @Override\n");
            builder.append("            public void onClick(View v) {\n");
            //builder.append("                host." + executableElement.getSimpleName().toString() + "(host.findViewById(" + id + "));\n");
            builder.append("                host." + executableElement.getSimpleName().toString() + "(v);\n");
            builder.append("            }\n");
            builder.append("        });\n");
        }
